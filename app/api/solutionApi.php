...
function searchSelling($conn){
    ...
    $messageArray=array();
    $data=array();
    $query="SELECT * FROM `onlyone` WHERE `id` LIKE '%$val%'  OR `namePerson`  LIKE '%$val%' OR `phone` LIKE '%$val%' OR `name` LIKE '%$val%' AND type='solution'";
    $result=$conn->query($query);
    if ($result) {
...
function  listAllSelling($conn){
    ...
    $messageArray=array();
    $data=array();
    $query="SELECT * FROM `onlyone` WHERE `type`='solution'";
    $result=$conn->query($query);
    if ($result) {
        while ($row=$result->fetch_assoc()) {
            $data[]=$row;
...
function deleteAllSelling($conn){
    extract($_POST);
    $messageArray=array();
    $query="DELETE FROM `onlyone` WHERE `type`='solution'";
    $result=$conn->query($query);
    if ($result) {
