    ...
    success:function (data) {
        ...
        if (status) {
            response.forEach(res => {
                ...
                tr+=`<td><a class="btn btn-success update" updateId=${res['id']} pey=${response[res]}><i class="fa fa-edit">pey</i></a><a class="btn btn-danger delete" deleteId=${res['id']} deletedName=${res['name']}>Delete</a></td>`;
                tr+=`</tr>`;
    ...
    $.ajax({
        ...
        success:function (data) {
            ...
            if (status) {
                ...
                $("#price").val(response['price']);$(".price").addClass("d-none");
...
$("#sellTpl").on("click",".print",function (e) {
    e.preventDefault();
    console.log('print');
