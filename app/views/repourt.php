...
<form id="repourtForm" method="post">
<div class="row">
  <div class="col-sm-4">
    <select name="" id="type" class="form-control">
      <option value="0">All Data</option>
      <option value="costome">Custom</option>
    </select>
  </div>
<div class="col-sm-4">
...
<div class="col-sm-12">
  <button type="submit" class="btn btn-info" id="addRepourt">Print</button>
</div>
</form>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" id="repourtTbl">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Order Type</th>
...
<script src="../js/repourt.js"></script>